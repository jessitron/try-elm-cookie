...
Elm.Cookie = Elm.Cookie || {};
Elm.Cookie.make = function (_elm) {
   "use strict";
   _elm.Cookie = _elm.Cookie || {};
   if (_elm.Cookie.values)
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Native$Cookie = Elm.Native.Cookie.make(_elm),
...
Elm.TryIt = Elm.TryIt || {};
Elm.TryIt.make = function (_elm) {
   "use strict";
   _elm.TryIt = _elm.TryIt || {};
   if (_elm.TryIt.values)
   ...
   key) {
      return function () {
         ...
         return $Effects.task($Task.map(interpreter)($Task.toResult($Cookie.get(key))));
      }();
   });
   ...
   var readMyCookie = A2(readCookie,
   function (a) {
   ...
   var writeMyCookie = function (str) {
      return A3(writeCookie,
      Failure,
      function (_v6) {
         return function () {
            return SetOk;
   ...
   _elm.TryIt.values = {_op: _op
                       ...
                       ,Failure: Failure
                       ,update: update
                       ,writeMyCookie: writeMyCookie
                       ,readMyCookie: readMyCookie
